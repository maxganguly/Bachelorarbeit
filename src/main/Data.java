...
/**
 * Utils class for Datatype management
 */
public class Data {
	
	/**
	 * A Map to cast Strings to primitive Objects with the objecttype as key
	 */
	...
	/**
	 * Maps the name to the class of primitive objects
	 */
	...
	/**
	 * Maps lexigraphical name of operators to code equivalent
	 */
